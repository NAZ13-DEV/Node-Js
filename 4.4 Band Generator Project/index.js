...
// Middleware to automatically add current year to every response
// app.use((req, res, next) => {
//   res.locals.year = new Date().getFullYear(); // Store the current year in res.locals
//   next();
// });
...
app.post("/submit", (req, res) => {
  ...
  res.render('index.ejs', {randomName: ` ${randomAdj} ${randomNoun}` });
});
